...
import financialLogoImage from "../../../assets/project-images/graphic-design/Financial-Logo.jpg";
import billboardImage from "../../../assets/project-images/graphic-design/Billboard.png";
import carInfographicImage from "../../../assets/project-images/graphic-design/Car-Infographic.jpg";
import sportsCollageImage from "../../../assets/project-images/graphic-design/Sports-Collage.jpg";
import businessCardImage from "../../../assets/project-images/graphic-design/Business-Card.png";
import infoMarketingDocImage from "../../../assets/project-images/graphic-design/Informational-Marketing-Document.png";
import formImage from "../../../assets/project-images/graphic-design/Form.png";
import logoImage from "../../../assets/project-images/graphic-design/Logo.png";
        ...
        <div>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {designProjects.map((project) => (
              <div className="break-inside-avoid" key={project.title}>
